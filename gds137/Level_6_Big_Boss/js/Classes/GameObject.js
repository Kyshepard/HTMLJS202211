...
{	
	...
	this.drawStar = function()
	{
		...
		context.lineTo(this.x - 11, this.y -11);
		context.lineTo(this.x -50, this.y - 11);
		context.lineTo(this.x - 25, this.y + 11);
		context.lineTo(this.x- 30, this.y + 50);
		context.lineTo(this.x, this.y + 27);
		context.lineTo(this.x + 30, this.y+ 50);
		context.lineTo(this.x + 25, this.y + 11);
		context.lineTo(this.x + 50, this.y - 11);
		context.lineTo(this.x + 11, this.y - 11);
